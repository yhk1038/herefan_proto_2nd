...
class WikiPostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wiki_post" do
    assert_difference('WikiPost.count') do
      post wiki_posts_url, params: { wiki_post: { commit_msg: @wiki_post.commit_msg, content: @wiki_post.content, row_count: @wiki_post.row_count, title: @wiki_post.title, url: @wiki_post.url, user_id: @wiki_post.user_id, wiki_id: @wiki_post.wiki_id } }
    end
  ...
  test "should update wiki_post" do
    patch wiki_post_url(@wiki_post), params: { wiki_post: { commit_msg: @wiki_post.commit_msg, content: @wiki_post.content, row_count: @wiki_post.row_count, title: @wiki_post.title, url: @wiki_post.url, user_id: @wiki_post.user_id, wiki_id: @wiki_post.wiki_id } }
