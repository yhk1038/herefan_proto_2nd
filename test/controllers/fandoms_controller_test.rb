...
class FandomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fandom" do
    assert_difference('Fandom.count') do
      post fandoms_url, params: { fandom: { background_img: @fandom.background_img, name: @fandom.name, profile_img: @fandom.profile_img } }
    end
  ...
  test "should update fandom" do
    patch fandom_url(@fandom), params: { fandom: { background_img: @fandom.background_img, name: @fandom.name, profile_img: @fandom.profile_img } }
