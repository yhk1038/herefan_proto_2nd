...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference('History.count') do
      post histories_url, params: { history: { event_date: @history.event_date, fandom_id: @history.fandom_id, title: @history.title, user_id: @history.user_id } }
    end
  ...
  test "should update history" do
    patch history_url(@history), params: { history: { event_date: @history.event_date, fandom_id: @history.fandom_id, title: @history.title, user_id: @history.user_id } }
